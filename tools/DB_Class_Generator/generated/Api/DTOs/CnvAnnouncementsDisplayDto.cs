...
namespace AdminPanel.Api.DTOs {
    public class CnvAnnouncementsDisplayDto : IDto {
        ...
        public string UngradedDiscussionOverrides { get; set; } = string.Empty;
        public int LockedForUser { get; set; } = 0;
        public string Message { get; set; } = string.Empty;
        public string SubscriptionHold { get; set; } = string.Empty;
